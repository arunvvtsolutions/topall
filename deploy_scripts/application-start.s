...
aws_arn="794038219445.dkr.ecr.ap-south-1.amazonaws.com"
...
container_name="${project_name}_${module_name}_${repo_name}"
...
# Start new container
docker run -d -p 3000:80 --name "$container_name" "$container_name:$release_version"
