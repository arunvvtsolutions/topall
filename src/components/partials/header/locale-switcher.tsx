      ...
      <SelectContent>
        <SelectItem value="en" className="border-none">
          <div className="flex items-center gap-1">
            ...
            />
            <span className="text-sm font-medium text-default-600 dark:text-default-700">En</span>
          </div>
        </SelectItem>
        <SelectItem value="ar">
          <div className="flex items-center gap-1">
            <Image
              ...
              className="h-6 w-6 rounded-full"
            />
            <span className="text-sm font-medium text-default-600 dark:text-default-700">Ar</span>
          </div>
        </SelectItem>
      </SelectContent>
    </Select>
