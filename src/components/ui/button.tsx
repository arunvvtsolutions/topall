...
const buttonVariants = cva(
  'inline-flex items-center  justify-center px-1 md:px-3 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-300  ring-offset-background transition-all focus-visible:outline-none focus-visible:hidden focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50',
  {
    variants: {
      color: {
        default: 'bg-default text-default-foreground hover:bg-default hover:ring-default dark:disabled:bg-default-500',
      ...
      variant: {
        ...
        inactive_outline: 'border border-borderad text- bg-default hover:bg-secondary  hover:ring-0 hover:ring-transparent'
      },
      shadow: {
        sm: 'shadow',
        md: 'shadow-md',
    ...
    compoundVariants: [
      ...
      },
      {
        variant: 'outline',
        color: 'success',
        className: 'text-success border-success hover:text-success-foreground hover:border-success hover:bg-success'
      },
      {
        variant: 'outline',
        color: 'info',
        className: 'text-info border-info hover:text-info-foreground hover:border-info hover:bg-info'
      },
      {
        variant: 'outline',
        color: 'warning',
        className: 'text-warning border-warning hover:text-warning-foreground hover:border-warning hover:bg-warning'
      },
      {
        variant: 'outline',
        color: 'destructive',
