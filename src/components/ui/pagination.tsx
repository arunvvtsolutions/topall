...
const PaginationLink = ({ className, isActive, size = 'icon', ...props }: PaginationLinkProps) => (
  <Link
    ...
    className={cn(
      buttonVariants({
        variant: isActive ? 'active_outline' : 'inactive_outline',
        size
      }),
      className
    )}
...
const PaginationPrevious = ({ className, showLabel, ...props }: React.ComponentProps<typeof PaginationLink>) => (
...
const PaginationNext = ({ className, showLabel, ...props }: React.ComponentProps<typeof PaginationLink>) => (
