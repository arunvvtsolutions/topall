...
export const inputVariants = cva(
  ' w-full  bg-background  rounded py-2 px-3 h-9 border text-sm font-normal border border-solid border-default-200 outline-none focus:outline-none  file:border-0 file:bg-transparent file:text-sm file:font-medium read-only:bg-default-200 disabled:cursor-not-allowed disabled:opacity-50  transition-all duration-300 ',
  {
    variants: {
      color: {
        default:
          'border-default-200 text-default-500 focus:outline-none dark:focus:border-default-500 disabled:bg-default-200  dark:disabled:bg-default-500  placeholder:text-accent-foreground/50',
        primary:
        ...
        secondary:
          'border-secondary-300 text-default-700  focus:border-secondary-400 disabled:bg-secondary/30 disabled:placeholder:text-secondary  placeholder:text-secondary-400',
